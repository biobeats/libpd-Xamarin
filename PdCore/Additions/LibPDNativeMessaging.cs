...
namespace LibPDBinding
{
	...
	public static partial class LibPD
	{
		...
		[DllImport("pd", EntryPoint="libpd_bind")]
		...
		[DllImport("pd", EntryPoint="libpd_unbind")]
		...
		[DllImport("pd", EntryPoint="libpd_bang")]
		...
		[DllImport("pd", EntryPoint="libpd_float")]
		...
		[DllImport("pd", EntryPoint="libpd_symbol")]
		...
		[DllImport("pd", EntryPoint="libpd_start_message")]
		private static extern  int start_message(int max_length) ;

		[DllImport("pd", EntryPoint="libpd_finish_message")]
		...
		[DllImport("pd", EntryPoint="libpd_finish_list")]
		...
		[DllImport("pd", EntryPoint="libpd_add_float")]
		private static extern  void add_float(float x) ;
		
		[DllImport("pd", EntryPoint="libpd_add_symbol")]
