...
namespace LibPDBinding
{
	...
	public static partial class LibPD
	{
		...
		/// <summary>
		/// You almost never have to call this! The only case is when the pd 
		...
		/// Init PD
		[DllImport("pd", EntryPoint="libpd_init")]
		private static extern void libpd_init() ;

				
		/// Return Type: void
		[DllImport("pd", EntryPoint="libpd_clear_search_path")]
		...
		/// Return Type: void
		///sym: char*
		[DllImport("pd", EntryPoint="libpd_add_to_search_path")]
		...
		///basename: char*
		///dirname: char*
		[DllImport("pd", EntryPoint="libpd_openfile")]
		...
		/// Return Type: void
		///p: void*
		[DllImport("pd", EntryPoint="libpd_closefile")]
		...
		/// Return Type: int
		///p: void*
		[DllImport("pd", EntryPoint="libpd_getdollarzero")]
		private static extern  int getdollarzero(IntPtr p) ;

				
		/// Return Type: int
		///sym: char*
		[DllImport("pd", EntryPoint="libpd_exists")]
		...
		/// Return Type: int
		[DllImport("pd", EntryPoint="libpd_blocksize")]
		...
		[DllImport("pd", EntryPoint="libpd_init_audio")]
		...
		[MethodImpl(MethodImplOptions.Synchronized)]
		public static extern bool ImplementsAudio();

		/// Return Type: int
		///inBuffer: float*
		///outBuffer: float*
		[DllImport("pd", EntryPoint="libpd_process_raw")]
		...
		///inBuffer: short*
		///outBuffer: short*
		[DllImport("pd", EntryPoint="libpd_process_short")]
		...
		///inBuffer: float*
		///outBuffer: float*
		[DllImport("pd", EntryPoint="libpd_process_float")]
		...
		///inBuffer: double*
		///outBuffer: double*
		[DllImport("pd", EntryPoint="libpd_process_double")]
		...
		/// Return Type: int
		///name: char*
		[DllImport("pd", EntryPoint="libpd_arraysize")]
		...
		[DllImport("pd", EntryPoint="libpd_read_array")]
		...
		[DllImport("pd", EntryPoint="libpd_write_array")]
