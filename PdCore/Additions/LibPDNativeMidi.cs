...
namespace LibPDBinding
{
	public static partial class LibPD
	{
		...
		[DllImport("pd", EntryPoint="libpd_noteon")]
		...
		[DllImport("pd", EntryPoint="libpd_controlchange")]
		...
		[DllImport("pd", EntryPoint="libpd_programchange")]
		...
		[DllImport("pd", EntryPoint="libpd_pitchbend")]
		...
		[DllImport("pd", EntryPoint="libpd_aftertouch")]
		...
		[DllImport("pd", EntryPoint="libpd_polyaftertouch")]
		...
		[DllImport("pd", EntryPoint="libpd_midibyte")]
		...
		[DllImport("pd", EntryPoint="libpd_sysex")]
		...
		[DllImport("pd", EntryPoint="libpd_sysrealtime")]
